    ...
    return ( 
        <div className="navBar d-flex">
            ...
            <div style={{flexGrow: 1}}>
                <img src="https://1.bp.blogspot.com/-ceZCvjagyFw/WNAx0UcFtiI/AAAAAAAAALk/k7s5kcUBK-0jjBBxodzfSrsrUNXmoTNqACLcB/s1600/logo%2Bstark1.jpg" onClick={props.onProfileImageClick} draggable="false" width="40" height="40" className="rounded-circle skeleton"/>
            </div>

            <div className="d-flex">

                <div className="pe-2">
                    <button className="btn pt-1 rounded-circle" type="button" onClick={props.onStatusSectionToggle}>
                ...
                <div className="pe-2" style={{marginLeft: '2px'}}>
                ...
                <div className="dropdown" style={{marginLeft: '2px'}}> 
                    <button className="btn dropdown-toggle rounded-circle" type="button" style={{width: '50px', height: '50px'}} id="profileMoreDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg viewBox="0 0 24 24" width="24" height="24" className="">
                    ...
                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="profileMoreDropdown">
